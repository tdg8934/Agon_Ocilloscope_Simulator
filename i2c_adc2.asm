...
mulLoopMSB:
    ...
    ld b, 0		;x screen position
    ld c, 8		;y screen position
    ld d, 8		;# of ;    call printBin
    ld a, l
    call printBin
...
string:
    ...
    .db 31, 4,1,"ADC MSB Hex"
    .db 31, 4,2,"ADC LSB Hex"       
    .db 31, 0,4,"ADC MSB+LSB Binary"
    .db 31, 0,7,"ADC Multiplied by 3"
endString:
